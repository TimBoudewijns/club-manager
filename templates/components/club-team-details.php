<?php
// File: templates/components/club-team-details.php
?>
<div class="bg-white rounded-2xl shadow-xl overflow-hidden border-t-4 border-blue-500">
    ...
    <div class="bg-white p-4 md:p-8">
        <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
            <div>
                ...
                <p class="text-gray-600 text-sm md:text-base">Viewing Club Team Roster (Read-only)</p>
            </div>
            <div class="bg-blue-100 text-blue-700 px-4 py-2 rounded-lg">
                <span class="font-semibold">Coach: <span x-text="selectedClubTeam?.coach"></span></span>
            </div>
        </div>
    </div>
    ...
    <div class="p-4 md:p-8">
                        ...
                        <tr class="hover:bg-blue-50 transition-colors">
                            ...
                            <td class="px-4 md:px-6 py-3 md:py-4 whitespace-nowrap text-center">
                                <div class="flex items-center justify-center space-x-1 md:space-x-2">
                                    ...
                                    <button @click="viewClubPlayerCard(player)" 
                                    ...
                                    <!-- History Button -->
                                    <button @click="viewClubPlayerHistory(player.id)" 
        ...
        <div x-show="clubTeamPlayers.length === 0" class="text-center py-12">
            ...
            <p class="text-gray-600">This team has no players assigned.</p>
        </div>
    </div>
</div>